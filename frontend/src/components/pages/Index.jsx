        ...
        return (
            <main class="calendar-contain">
                ...
                <section class="title-bar">
                    <span class="title-bar__month" onclick="toggleSelector('selector-month')">
                        September
                    ...
                    <span style={{marginLeft: '10px'}} class="title-bar__month" onclick="toggleSelector('selector-year')">
                        2020
                    ...
                    <span style={{marginLeft: '10px'}} class="title-bar__month" onclick="toggleSelector('selector-city')">
                        Rochester
                    ...
                    <span style={{marginLeft: '10px'}} class="title-bar__month" onclick="toggleSelector('selector-vendor')">
                        All

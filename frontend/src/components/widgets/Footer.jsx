                        ...
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="single-footer-widget mb-60 wow fadeInUp" data-wow-delay="300ms">
                                ...
                                <div class="social-info">
                                    <a href="facebook.com"><i class="zmdi zmdi-facebook"></i></a>
                                    <a href="instagram.com"><i class="zmdi zmdi-instagram"></i></a>
                                    <a href="twitter.com"><i class="zmdi zmdi-twitter"></i></a>
                                    <a href="linkedin.com"><i class="zmdi zmdi-linkedin"></i></a>
                                </div>
                            </div>
                        </div>
